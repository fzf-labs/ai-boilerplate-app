...
const TableNameSelfApp = "self_app"

// SelfApp mapped from table <self_app>
type SelfApp struct {
	...
	Name        string         `gorm:"column:name;type:character varying(255);not null;comment:应用名称" json:"name"`              // 应用名称
	Description string         `gorm:"column:description;type:text;comment:应用描述" json:"description"`                           // 应用描述
...
// TableName SelfApp's table name
func (*SelfApp) TableName() string {
	return TableNameSelfApp
}
