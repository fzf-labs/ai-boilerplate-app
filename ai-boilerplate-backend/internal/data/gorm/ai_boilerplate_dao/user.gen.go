...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&ai_boilerplate_model.User{})
	...
	_user.WxGzhUserID = field.NewString(tableName, "wx_gzh_user_id")
	_user.WxGzhXcxID = field.NewString(tableName, "wx_gzh_xcx_id")
...
type user struct {
	...
	WxGzhUserID field.String // 公众号用户Id
	WxGzhXcxID  field.String // 小程序用户Id
...
func (u *user) updateTableName(table string) *user {
	...
	u.WxGzhUserID = field.NewString(table, "wx_gzh_user_id")
	u.WxGzhXcxID = field.NewString(table, "wx_gzh_xcx_id")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["wx_gzh_user_id"] = u.WxGzhUserID
	u.fieldMap["wx_gzh_xcx_id"] = u.WxGzhXcxID
...
func (u userDo) Create(values ...*ai_boilerplate_model.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*ai_boilerplate_model.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*ai_boilerplate_model.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*ai_boilerplate_model.User, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*ai_boilerplate_model.User), nil
	}
}

func (u userDo) Take() (*ai_boilerplate_model.User, error) {
...
func (u userDo) Last() (*ai_boilerplate_model.User, error) {
...
func (u userDo) Find() ([]*ai_boilerplate_model.User, error) {
	result, err := u.DO.Find()
	return result.([]*ai_boilerplate_model.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*ai_boilerplate_model.User, err error) {
	buf := make([]*ai_boilerplate_model.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*ai_boilerplate_model.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*ai_boilerplate_model.User, error) {
...
func (u userDo) FirstOrCreate() (*ai_boilerplate_model.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*ai_boilerplate_model.User, count int64, err error) {
...
func (u userDo) Delete(models ...*ai_boilerplate_model.User) (result gen.ResultInfo, err error) {
