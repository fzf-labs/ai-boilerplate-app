...
func newSysRole(db *gorm.DB, opts ...gen.DOOption) sysRole {
	...
	_sysRole.sysRoleDo.UseModel(&ai_boilerplate_model.SysRole{})
	...
	_sysRole.DataScope = field.NewString(tableName, "dataScope")
	_sysRole.MenuIds = field.NewField(tableName, "menuIds")
...
func (s *sysRole) updateTableName(table string) *sysRole {
	...
	s.DataScope = field.NewString(table, "dataScope")
...
func (s *sysRole) fillFieldMap() {
	...
	s.fieldMap["dataScope"] = s.DataScope
...
func (s sysRoleDo) Create(values ...*ai_boilerplate_model.SysRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysRoleDo) CreateInBatches(values []*ai_boilerplate_model.SysRole, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysRoleDo) Save(values ...*ai_boilerplate_model.SysRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysRoleDo) First() (*ai_boilerplate_model.SysRole, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*ai_boilerplate_model.SysRole), nil
	}
}

func (s sysRoleDo) Take() (*ai_boilerplate_model.SysRole, error) {
...
func (s sysRoleDo) Last() (*ai_boilerplate_model.SysRole, error) {
...
func (s sysRoleDo) Find() ([]*ai_boilerplate_model.SysRole, error) {
	result, err := s.DO.Find()
	return result.([]*ai_boilerplate_model.SysRole), err
}

func (s sysRoleDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*ai_boilerplate_model.SysRole, err error) {
	buf := make([]*ai_boilerplate_model.SysRole, 0, batchSize)
...
func (s sysRoleDo) FindInBatches(result *[]*ai_boilerplate_model.SysRole, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysRoleDo) FirstOrInit() (*ai_boilerplate_model.SysRole, error) {
...
func (s sysRoleDo) FirstOrCreate() (*ai_boilerplate_model.SysRole, error) {
...
func (s sysRoleDo) FindByPage(offset int, limit int) (result []*ai_boilerplate_model.SysRole, count int64, err error) {
...
func (s sysRoleDo) Delete(models ...*ai_boilerplate_model.SysRole) (result gen.ResultInfo, err error) {
