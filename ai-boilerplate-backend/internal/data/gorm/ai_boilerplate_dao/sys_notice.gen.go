...
func newSysNotice(db *gorm.DB, opts ...gen.DOOption) sysNotice {
	...
	_sysNotice.sysNoticeDo.UseModel(&ai_boilerplate_model.SysNotice{})

	tableName := _sysNotice.sysNoticeDo.TableName()
	_sysNotice.ALL = field.NewAsterisk(tableName)
	_sysNotice.ID = field.NewString(tableName, "id")
	...
	_sysNotice.Status = field.NewInt16(tableName, "status")
	_sysNotice.CreatedAt = field.NewTime(tableName, "created_at")
	_sysNotice.UpdatedAt = field.NewTime(tableName, "updated_at")
	_sysNotice.DeletedAt = field.NewField(tableName, "deleted_at")
...
func (s sysNoticeDo) Create(values ...*ai_boilerplate_model.SysNotice) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysNoticeDo) CreateInBatches(values []*ai_boilerplate_model.SysNotice, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysNoticeDo) Save(values ...*ai_boilerplate_model.SysNotice) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysNoticeDo) First() (*ai_boilerplate_model.SysNotice, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*ai_boilerplate_model.SysNotice), nil
	}
}

func (s sysNoticeDo) Take() (*ai_boilerplate_model.SysNotice, error) {
...
func (s sysNoticeDo) Last() (*ai_boilerplate_model.SysNotice, error) {
...
func (s sysNoticeDo) Find() ([]*ai_boilerplate_model.SysNotice, error) {
	result, err := s.DO.Find()
	return result.([]*ai_boilerplate_model.SysNotice), err
}

func (s sysNoticeDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*ai_boilerplate_model.SysNotice, err error) {
	buf := make([]*ai_boilerplate_model.SysNotice, 0, batchSize)
...
func (s sysNoticeDo) FindInBatches(result *[]*ai_boilerplate_model.SysNotice, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysNoticeDo) FirstOrInit() (*ai_boilerplate_model.SysNotice, error) {
...
func (s sysNoticeDo) FirstOrCreate() (*ai_boilerplate_model.SysNotice, error) {
...
func (s sysNoticeDo) FindByPage(offset int, limit int) (result []*ai_boilerplate_model.SysNotice, count int64, err error) {
...
func (s sysNoticeDo) Delete(models ...*ai_boilerplate_model.SysNotice) (result gen.ResultInfo, err error) {
