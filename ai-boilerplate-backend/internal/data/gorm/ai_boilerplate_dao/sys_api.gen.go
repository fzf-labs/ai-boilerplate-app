...
func newSysAPI(db *gorm.DB, opts ...gen.DOOption) sysAPI {
	...
	_sysAPI.sysAPIDo.UseModel(&ai_boilerplate_model.SysAPI{})
...
func (s sysAPIDo) Create(values ...*ai_boilerplate_model.SysAPI) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysAPIDo) CreateInBatches(values []*ai_boilerplate_model.SysAPI, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysAPIDo) Save(values ...*ai_boilerplate_model.SysAPI) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysAPIDo) First() (*ai_boilerplate_model.SysAPI, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*ai_boilerplate_model.SysAPI), nil
	}
}

func (s sysAPIDo) Take() (*ai_boilerplate_model.SysAPI, error) {
...
func (s sysAPIDo) Last() (*ai_boilerplate_model.SysAPI, error) {
...
func (s sysAPIDo) Find() ([]*ai_boilerplate_model.SysAPI, error) {
	result, err := s.DO.Find()
	return result.([]*ai_boilerplate_model.SysAPI), err
}

func (s sysAPIDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*ai_boilerplate_model.SysAPI, err error) {
	buf := make([]*ai_boilerplate_model.SysAPI, 0, batchSize)
...
func (s sysAPIDo) FindInBatches(result *[]*ai_boilerplate_model.SysAPI, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysAPIDo) FirstOrInit() (*ai_boilerplate_model.SysAPI, error) {
...
func (s sysAPIDo) FirstOrCreate() (*ai_boilerplate_model.SysAPI, error) {
...
func (s sysAPIDo) FindByPage(offset int, limit int) (result []*ai_boilerplate_model.SysAPI, count int64, err error) {
...
func (s sysAPIDo) Delete(models ...*ai_boilerplate_model.SysAPI) (result gen.ResultInfo, err error) {
