...
func newSensitiveWord(db *gorm.DB, opts ...gen.DOOption) sensitiveWord {
	...
	_sensitiveWord.sensitiveWordDo.UseModel(&ai_boilerplate_model.SensitiveWord{})
	...
	_sensitiveWord.Lab = field.NewString(tableName, "lab")
...
func (s *sensitiveWord) updateTableName(table string) *sensitiveWord {
	...
	s.Lab = field.NewString(table, "lab")
...
func (s sensitiveWordDo) Create(values ...*ai_boilerplate_model.SensitiveWord) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sensitiveWordDo) CreateInBatches(values []*ai_boilerplate_model.SensitiveWord, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sensitiveWordDo) Save(values ...*ai_boilerplate_model.SensitiveWord) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sensitiveWordDo) First() (*ai_boilerplate_model.SensitiveWord, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*ai_boilerplate_model.SensitiveWord), nil
	}
}

func (s sensitiveWordDo) Take() (*ai_boilerplate_model.SensitiveWord, error) {
...
func (s sensitiveWordDo) Last() (*ai_boilerplate_model.SensitiveWord, error) {
...
func (s sensitiveWordDo) Find() ([]*ai_boilerplate_model.SensitiveWord, error) {
	result, err := s.DO.Find()
	return result.([]*ai_boilerplate_model.SensitiveWord), err
}

func (s sensitiveWordDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*ai_boilerplate_model.SensitiveWord, err error) {
	buf := make([]*ai_boilerplate_model.SensitiveWord, 0, batchSize)
...
func (s sensitiveWordDo) FindInBatches(result *[]*ai_boilerplate_model.SensitiveWord, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sensitiveWordDo) FirstOrInit() (*ai_boilerplate_model.SensitiveWord, error) {
...
func (s sensitiveWordDo) FirstOrCreate() (*ai_boilerplate_model.SensitiveWord, error) {
...
func (s sensitiveWordDo) FindByPage(offset int, limit int) (result []*ai_boilerplate_model.SensitiveWord, count int64, err error) {
...
func (s sensitiveWordDo) Delete(models ...*ai_boilerplate_model.SensitiveWord) (result gen.ResultInfo, err error) {
