...
func newSysDept(db *gorm.DB, opts ...gen.DOOption) sysDept {
	...
	_sysDept.sysDeptDo.UseModel(&ai_boilerplate_model.SysDept{})
	...
	_sysDept.AdminID = field.NewString(tableName, "admin_id")
...
func (s sysDeptDo) Create(values ...*ai_boilerplate_model.SysDept) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysDeptDo) CreateInBatches(values []*ai_boilerplate_model.SysDept, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysDeptDo) Save(values ...*ai_boilerplate_model.SysDept) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysDeptDo) First() (*ai_boilerplate_model.SysDept, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*ai_boilerplate_model.SysDept), nil
	}
}

func (s sysDeptDo) Take() (*ai_boilerplate_model.SysDept, error) {
...
func (s sysDeptDo) Last() (*ai_boilerplate_model.SysDept, error) {
...
func (s sysDeptDo) Find() ([]*ai_boilerplate_model.SysDept, error) {
	result, err := s.DO.Find()
	return result.([]*ai_boilerplate_model.SysDept), err
}

func (s sysDeptDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*ai_boilerplate_model.SysDept, err error) {
	buf := make([]*ai_boilerplate_model.SysDept, 0, batchSize)
...
func (s sysDeptDo) FindInBatches(result *[]*ai_boilerplate_model.SysDept, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysDeptDo) FirstOrInit() (*ai_boilerplate_model.SysDept, error) {
...
func (s sysDeptDo) FirstOrCreate() (*ai_boilerplate_model.SysDept, error) {
...
func (s sysDeptDo) FindByPage(offset int, limit int) (result []*ai_boilerplate_model.SysDept, count int64, err error) {
...
func (s sysDeptDo) Delete(models ...*ai_boilerplate_model.SysDept) (result gen.ResultInfo, err error) {
