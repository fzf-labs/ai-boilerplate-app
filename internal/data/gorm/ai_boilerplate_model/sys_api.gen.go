...
type SysAPI struct {
	...
	PermissionID string         `gorm:"column:permission_id;type:uuid;not null;comment:权限Id" json:"permissionId"`               // 权限Id
	Method       string         `gorm:"column:method;type:character varying(32);not null;comment:方法" json:"method"`             // 方法
	Path         string         `gorm:"column:path;type:character varying(255);not null;comment:路径" json:"path"`                // 路径
