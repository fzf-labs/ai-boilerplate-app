...
func newSysAdmin(db *gorm.DB, opts ...gen.DOOption) sysAdmin {
	...
	_sysAdmin.sysAdminDo.UseModel(&ai_boilerplate_model.SysAdmin{})
	...
	_sysAdmin.Sex = field.NewInt16(tableName, "sex")
	_sysAdmin.Mobile = field.NewString(tableName, "mobile")
	_sysAdmin.RoleID = field.NewString(tableName, "role_id")
	_sysAdmin.DeptID = field.NewString(tableName, "dept_id")
	_sysAdmin.PostID = field.NewString(tableName, "post_id")
...
func (s sysAdminDo) Create(values ...*ai_boilerplate_model.SysAdmin) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysAdminDo) CreateInBatches(values []*ai_boilerplate_model.SysAdmin, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysAdminDo) Save(values ...*ai_boilerplate_model.SysAdmin) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysAdminDo) First() (*ai_boilerplate_model.SysAdmin, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*ai_boilerplate_model.SysAdmin), nil
	}
}

func (s sysAdminDo) Take() (*ai_boilerplate_model.SysAdmin, error) {
...
func (s sysAdminDo) Last() (*ai_boilerplate_model.SysAdmin, error) {
...
func (s sysAdminDo) Find() ([]*ai_boilerplate_model.SysAdmin, error) {
	result, err := s.DO.Find()
	return result.([]*ai_boilerplate_model.SysAdmin), err
}

func (s sysAdminDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*ai_boilerplate_model.SysAdmin, err error) {
	buf := make([]*ai_boilerplate_model.SysAdmin, 0, batchSize)
...
func (s sysAdminDo) FindInBatches(result *[]*ai_boilerplate_model.SysAdmin, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysAdminDo) FirstOrInit() (*ai_boilerplate_model.SysAdmin, error) {
...
func (s sysAdminDo) FirstOrCreate() (*ai_boilerplate_model.SysAdmin, error) {
...
func (s sysAdminDo) FindByPage(offset int, limit int) (result []*ai_boilerplate_model.SysAdmin, count int64, err error) {
...
func (s sysAdminDo) Delete(models ...*ai_boilerplate_model.SysAdmin) (result gen.ResultInfo, err error) {
