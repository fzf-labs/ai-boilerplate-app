...
func newDictType(db *gorm.DB, opts ...gen.DOOption) dictType {
	...
	_dictType.dictTypeDo.UseModel(&ai_boilerplate_model.DictType{})
...
func (d dictTypeDo) Create(values ...*ai_boilerplate_model.DictType) error {
	if len(values) == 0 {
		return nil
	}
...
func (d dictTypeDo) CreateInBatches(values []*ai_boilerplate_model.DictType, batchSize int) error {
	return d.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (d dictTypeDo) Save(values ...*ai_boilerplate_model.DictType) error {
	if len(values) == 0 {
		return nil
	}
...
func (d dictTypeDo) First() (*ai_boilerplate_model.DictType, error) {
	if result, err := d.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*ai_boilerplate_model.DictType), nil
	}
}

func (d dictTypeDo) Take() (*ai_boilerplate_model.DictType, error) {
...
func (d dictTypeDo) Last() (*ai_boilerplate_model.DictType, error) {
...
func (d dictTypeDo) Find() ([]*ai_boilerplate_model.DictType, error) {
	result, err := d.DO.Find()
	return result.([]*ai_boilerplate_model.DictType), err
}

func (d dictTypeDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*ai_boilerplate_model.DictType, err error) {
	buf := make([]*ai_boilerplate_model.DictType, 0, batchSize)
...
func (d dictTypeDo) FindInBatches(result *[]*ai_boilerplate_model.DictType, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (d dictTypeDo) FirstOrInit() (*ai_boilerplate_model.DictType, error) {
...
func (d dictTypeDo) FirstOrCreate() (*ai_boilerplate_model.DictType, error) {
...
func (d dictTypeDo) FindByPage(offset int, limit int) (result []*ai_boilerplate_model.DictType, count int64, err error) {
...
func (d dictTypeDo) Delete(models ...*ai_boilerplate_model.DictType) (result gen.ResultInfo, err error) {
