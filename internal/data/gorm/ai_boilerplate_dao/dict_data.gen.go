...
func newDictDatum(db *gorm.DB, opts ...gen.DOOption) dictDatum {
	...
	_dictDatum.dictDatumDo.UseModel(&ai_boilerplate_model.DictDatum{})
	...
	_dictDatum.Key = field.NewString(tableName, "key")
...
func (d dictDatumDo) Create(values ...*ai_boilerplate_model.DictDatum) error {
	if len(values) == 0 {
		return nil
	}
...
func (d dictDatumDo) CreateInBatches(values []*ai_boilerplate_model.DictDatum, batchSize int) error {
	return d.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (d dictDatumDo) Save(values ...*ai_boilerplate_model.DictDatum) error {
	if len(values) == 0 {
		return nil
	}
...
func (d dictDatumDo) First() (*ai_boilerplate_model.DictDatum, error) {
	if result, err := d.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*ai_boilerplate_model.DictDatum), nil
	}
}

func (d dictDatumDo) Take() (*ai_boilerplate_model.DictDatum, error) {
...
func (d dictDatumDo) Last() (*ai_boilerplate_model.DictDatum, error) {
...
func (d dictDatumDo) Find() ([]*ai_boilerplate_model.DictDatum, error) {
	result, err := d.DO.Find()
	return result.([]*ai_boilerplate_model.DictDatum), err
}

func (d dictDatumDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*ai_boilerplate_model.DictDatum, err error) {
	buf := make([]*ai_boilerplate_model.DictDatum, 0, batchSize)
...
func (d dictDatumDo) FindInBatches(result *[]*ai_boilerplate_model.DictDatum, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (d dictDatumDo) FirstOrInit() (*ai_boilerplate_model.DictDatum, error) {
...
func (d dictDatumDo) FirstOrCreate() (*ai_boilerplate_model.DictDatum, error) {
...
func (d dictDatumDo) FindByPage(offset int, limit int) (result []*ai_boilerplate_model.DictDatum, count int64, err error) {
...
func (d dictDatumDo) Delete(models ...*ai_boilerplate_model.DictDatum) (result gen.ResultInfo, err error) {
