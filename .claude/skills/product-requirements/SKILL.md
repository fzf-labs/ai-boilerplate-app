...
- **Output**: Professional yet concise PRDs saved to `docs/{date}-{feature-name}/prd.md`
...
Generating professional PRD at docs/{date}-{feature-name}/prd.md..."
```

Generate PRD using template below, then confirm:
```
"✅ PRD saved to docs/{date}-{feature-name}/prd.md
...
Save to: `docs/{date}-{feature-name}/prd.md`
...
- ✅ Save to `docs/{date}-{feature-name}/prd.md` with proper naming
